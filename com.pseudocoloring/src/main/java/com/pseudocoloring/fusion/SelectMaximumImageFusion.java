...
public class SelectMaximumImageFusion {
	...
	public SelectMaximumImageFusion(String firstImagePath,
	...
	public BufferedImage getSelectMaximumImageFusion() {
		log.info("Select Maximum Image Fusion has started.");
		for (int y = 0; y < firstImage.getHeight(); y++) {
			for (int x = 0; x < firstImage.getWidth(); x++) {
				...
				int redFusionedValue = (red1 >= red2) ? red1 : red2;
				int greenFusionedValue = (green1 >= green2) ? green1 : green2;
				int blueFusionedValue = (blue1 >= blue2) ? blue1 : blue2;
		...
		log.info("Select Maximum Image Fusion is finished.");
		return secondImage;
	}
}
